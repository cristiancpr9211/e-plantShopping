...
import { addItem } from './CartSlice'; // import your Redux action
    ...
    return (
        <div>
            ...
            <div className="tag">
               ...
               <a href="https://cristiancpr9211.github.io/e-plantShopping/" style={{textDecoration:'none'}}>
                        <div>
...
>
  {addedToCart[plant.name] ? "Item Added" : "Add to Cart"}
</button>
